      ...
      <div class="shop-info">
        ...
        <div class="info-section">
          ...
          <div class="info-card">
            ...
            <div class="impact-item"><span class="impact-icon">🏙️</span><span class="impact-text"><strong>Aiding Unsheltered Neighbors</strong> – Alleviating discomfort of living on the streets.</span></div>
    ...
    <div id="impact-tab-content">
      <div id="impact-screen">
        ...
        <div class="impact-pills">
          ...
          <div class="impact-pill">🛋️ Street Relief</div>
        </div>
      </div>
      ...
      <div id="impact-wrapper">
        ...
        <div class="impact-grid-cards">
          ...
          <div class="impact-card"><div class="impact-card-icon">🛋️</div><h3>Street Relief</h3><p>Alleviating the discomfort of living on the street — dignity through donations</p></div>
        </div>
